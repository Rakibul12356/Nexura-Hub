  ...
  return (
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      ...
      <PopoverContent
        ...
        sideOffset={8}
        collisionPadding={12}
        className="w-[280px] sm:w-80 p-0 rounded-2xl bg-popover text-popover-foreground shadow-2xl border overflow-hidden"
      >
          ...
          {notifications.length === 0 ? (
            ...
            notifications.map((item) => (
              ...
              >
                ...
                <p className="text-muted-foreground leading-relaxed pl-5 text-[11px]">{item.message}</p>
              </div>
            ))
          )}
        </div>
